namespace TenderBase
{
    ...
    {
        /// <summary> Gets class obejct objects which can be inserted in this index</summary>
        /// <returns> class specified in Storage.createFielIndex method
        /// </returns>
        Type IndexedClass
        {
            get;
        ...
        /// <summary> Gets fields used as a key</summary>
        /// <returns> array of index key fields
        /// </returns>
        FieldInfo[] KeyFields
        {
            get;
        ...
        /// <summary> Associate new object with the key specified by object field value.
        ...
        /// <summary> Assign to the integer indexed field unique autoicremented value and
        ...
        /// its forced to become persistent by assigning OID to it.
        /// </param>
        /// <exception cref="StorageError(StorageError.INCOMPATIBLE_KEY_TYPE)">when indexed field
        ...
        /// <summary> Remove object with specified key from the unique index</summary>
        ...
        /// <summary> Check if index contains specified object</summary>
