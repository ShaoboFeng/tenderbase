namespace TenderBase
{
    ...
    /// </summary>
    /// <seealso cref="TenderBase.AssertionFailed">
    /// </seealso>
    public class Assert
    {
        ...
        /// <param name="cond">result of checked condition
        /// </param>
        public static void That(string description, bool cond)
        {
            if (!cond)
            {
        ...
        /// <summary> Throw assertion failed exception.</summary>
        public static void Failed()
        {
            throw new AssertionFailed();
        }

        /// <summary> Throw assertion failed exception with given description.</summary>
