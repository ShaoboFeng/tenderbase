namespace TenderBase
{
    ...
    /// <summary> Information about memory usage for the correspondent class.
    ...
    {
        /// <summary> Class of persistent object or Storage for database internal data</summary>
        public Type cls;

        /// <summary> Number of reachable instance of the particular class in the database.</summary>
        public int nInstances;

        /// <summary> Total size of all reachable instances</summary>
        public long totalSize;

        /// <summary> Real allocated size of all instances. Database allocates space for th objects using quantums,
        ...
        /// <summary> MemoryUsage constructor</summary>
        public MemoryUsage(Type cls)
        {
            this.cls = cls;
        }
    }
