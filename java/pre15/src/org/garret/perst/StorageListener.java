...
public abstract class StorageListener {
    /**
     * This method is called during database open when database was not
    ...
    /**
     * This method is called when garbage collection is  started (either explicitly
     * by invocation of Storage.gc() method, or implicitly  after allocation
     ...
     * repeated, <code>false</code> if no more attempts to communicate with this host should be performed 
     */
