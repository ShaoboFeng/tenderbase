...
{ 
     ...
     * Object can be not yet persistent, in which case
     * it is forced to become persistent by assigning OID to it.
     ...
     * then it will be removed from the index and new value will be associated with this key.
     * @param obj object to be inserted in the index. Object should contain indexed field. 
     * Object can be not yet persistent, in which case
     * it is forced to become persistent by assigning OID to it.
    ...
    /**
     * Assign to the integer indexed field unique auto-incremented value and 
     ...
     * @param obj object to be removed from the index. Object should contain indexed field. 
