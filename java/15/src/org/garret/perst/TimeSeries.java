 ...
 * handling of time series data. Usually time series contain a very large number
 * if relatively small elements which are usually accessed in successive order. 
 ...
 * Perst needs to know format of block class, it is responsibility of programmer
...
public interface TimeSeries<T extends TimeSeries.Tick> extends IPersistent, IResource, Collection<T> { 
     ...
     * Programmer has to define its own block class derived from this class
     * containing array of time series elements and providing getTicks()
    ...
    public static abstract class Block extends Persistent { 
         ...
         * But all array items should be not null and contain reference to Tick object.
         */
