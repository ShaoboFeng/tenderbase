...
/**
 * Information about memory usage for the corresponding class. 
...
public class MemoryUsage {
    ...
    /**
     * Real allocated size of all instances. Database allocates space for n-th objects using quantums,
     * for example object with size 25 bytes will use 32 bytes in the storage. 
