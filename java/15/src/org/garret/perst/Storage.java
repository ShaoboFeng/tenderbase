...
public interface Storage { 
     ...
     * to contain all database file pages
     */
     ...
     * B-Tree implementation (set "perst.alternative.btree" property).
   ...
   /**
    ...
    /**
     * Get database memory dump. This function returns hashmap whose keys are classes
     * of stored objects and values are MemoryUsage objects which specify number of instances
     ...
     * <p>This method traverses the storage as garbage collection do - starting from the root object
     * and recursively visiting all reachable objects. So it reports statistics only for visible objects.
